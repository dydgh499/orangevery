            ...
            <VCol cols="12">
                <VCard title="검색 옵션">
                    ...
                    <VTable fixed-header class="text-no-wrap">
                        ...
                        <thead>
                            <tr>
                                <th v-for="header in store.headers" :key="header.ko" scope="col" v-show="!Boolean(header.hidden)">
                                    {{ header.ko }}
                                </th>
                        ...
                        <tbody>
                            <tr v-for="user in store.items" :key="user.id" style="height: 3.75rem;">
                                <td v-for="header in store.headers" :key="header.key" scope="col" v-show="!Boolean(header.hidden)">
                                    <span>
                                        {{ user[header.key] }}
                                    </span>
                                </td>
