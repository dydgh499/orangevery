...
store.params.is_use_realtime_deposit = corp.pv_options.paid.use_realtime_deposit ? 1 : 0
...
<template>
    <div>
        <BaseIndexView placeholder="별칭, MID, TID, 승인번호, 거래번호, 결제모듈 별칭, 주민번호, 사업자번호 검색" :metas="metas" :add="user_info.level >= 35" add_name="매출"
            :is_range_date="true">
            <template #filter>
