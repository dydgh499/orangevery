...
import SimplePayOverview from '@/views/transactions/simple/SimplePayOverview.vue'
...
axios.get('/api/v1/manager/merchandises/all?module_type=3')
    .then(r => { Object.assign(merchandises.value, r.data.content as Merchandise[]) })
    .catch(e => { console.log(e) })

const filterPayMod = computed(() => {
    const filter = pay_modules.filter((obj: PayModule) => { return obj.mcht_id == mcht_id.value && obj.module_type == 3 })
                ...
                <VRow class="match-height">
                    <VCol cols="12" md="12" class="d-flex justify-center align-center">
                        <div style="width: 700px;">
                            ...
                            <SimplePayOverview :pmod_id="pmod_id || 0" :installment="installment || 0" :pg_id="pg_id" :return_url="return_url">
                                <template #explain>
                                    <VCol cols="12">
                                        <VRow no-gutters>
