...
provide('billKeySelectDialog', billKeySelectDialog)
...
<template>
    <div>
        <BaseIndexView :placeholder="'카드번호 검색'" :metas="[]" :add="false" add_name=""
            :date_filter_type="DateFilters.NOT_USE">
            <template #filter>
            </template>
            <template #index_extra_field>
                <VBtn prepend-icon="tabler-plus" @click="billKeySelectDialog.show({ id: 0 })"
