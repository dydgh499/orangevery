...
export const useStore = defineStore('payGatewayStore', () => {
    ...
    const pg_companies = [
        ...
        {id:39, name:'씨드페이먼츠', rep_name:'김정훈', company_name:'주식회사 씨드파이낸셜', business_num:'320-86-02487', phone_num:'02-861-7717', addr:'서울특별시 금천구 가산디지털2로 144, 5층 507,508호(가산동, 현대 테라타워)'},
