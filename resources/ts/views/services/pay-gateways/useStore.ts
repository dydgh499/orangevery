...
export const useStore = defineStore('payGatewayStore', () => {
    ...
    const pg_companies = [
        ...
        {id:24, name:'패스고', rep_name:'황태현, 정대철', company_name:'주)무신사페이먼츠', business_num:'578-81-01933', phone_num:'031-211-6990', addr:'경기도 수원시 영통구 광교중앙로248번길 7-2(하동, 원희캐슬 광교) B동 302호'},
    ]
