...
export const useSearchStore = defineStore('payModSearchStore', () => {    
    const store = Searcher('services/pay-modules')
    const head  = Header('services/pay-modules', '결제모듈 관리')
...
*/
    const getLimitCols = () => {
        ...
        headers_7['pay_day_limit'] = '일(영업일)'
        headers_7['pay_day_holiday_limit'] = '일(휴무일)'
        headers_7['pay_single_limit'] = '단건(영업일)'
        headers_7['pay_single_holiday_limit'] = '단건(휴무일)'
        return headers_7
    }
    /*
...
export const defaultItemInfo =  () => {   
    ...
    const item  = reactive<PayModule>({
        ...
        pay_month_limit: 0,
        pay_day_limit: 0,
        pay_day_holiday_limit: 0,
        pay_single_limit: 0,
        pay_single_holiday_limit: 0,
