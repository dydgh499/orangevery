...
export const useSearchStore = defineStore('operatorHistoryV2SearchStore', () => {
    const store = Searcher('services/operator-historiesv2')
    const head = Header('services/operator-historiesv2', '운영자 활동이력')
