...
import type { Options, SimplePay, PayGateway } from '@/views/types'
...
watchEffect(() => {
    ...
    if (pg) {
        ...
        link.value = 'http://localhost:81/v2/pay/simple/' + path
    }
})
</script>
<template>
                ...
                <div>
                    ...
                    <VCol cols="12">
                        ...
                        <CreateHalfVCol :mdl="4" :mdr="8" style="padding: 0;">
                            ...
                            <template #input>
                                <VTextField v-model="simple_pay_info.phone" type="number" name="phone"
