                ...
                <div>
                    ...
                    <VCol cols="12">
                        <CreateHalfVCol :mdl="4" :mdr="8" style="padding: 0;">
                            ...
                            <template #input>
                                <VTextField v-model="simple_pay_info.item_name" type="text" name="item_name" :value="item_name"
                        ...
                        <CreateHalfVCol :mdl="4" :mdr="8" style="padding: 0;">
                            ...
                            <template #input>
                                <VTextField v-model="simple_pay_info.amount" type="number" suffix="₩" name="amount" :value="amount"
                        ...
                        <CreateHalfVCol :mdl="4" :mdr="8" style="padding: 24px 0;">
                            ...
                            <template #input>
                                <VTextField v-model="simple_pay_info.buyer_name" type="text" name="buyer_name" :value="buyer_name"
                        ...
                        <CreateHalfVCol :mdl="4" :mdr="8" style="padding: 0;">
                            ...
                            <template #input>
                                <VTextField v-model="simple_pay_info.phone" type="number" name="phone" :value="phone_num"
