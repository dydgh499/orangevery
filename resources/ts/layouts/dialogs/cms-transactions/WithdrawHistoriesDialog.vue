...
const history = ref<CmsTransactionHistory[]>([])
        ...
        <VTable class="text-no-wrap" style="width: 100%;">
          <thead>
            <tr>
              ...
              <th class="list-square">출금결과메세지</th>
          ...
          <!-- ✅ 단일 이력만 표시 -->
          <tbody v-if="history">
            <tr :class="withdrawStatusColors(history)">
              ...
              <td class="list-square">{{ history.result_msg }}</td>
              <td class="list-square">{{ history.amount.toLocaleString() }}</td>
              <td class="list-square">{{ history.ct_id }}</td>
