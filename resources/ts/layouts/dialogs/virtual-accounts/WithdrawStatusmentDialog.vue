                    ...
                    <table class="mt-2">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width: 25%;">- {{ statement.trans_amount.toLocaleString() }}원</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="mt-2">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width: 25%;">{{ statement.user_name }}</td>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center" style="width: 30%;">{{ statement.trans_amount.toLocaleString() }}원</td>
