                            ...
                            <VRow no-gutters style="align-items: center;">
                                ...
                                <VCol md="8">
                                    <div class="batch-container">
                                        ...
                                        <VBtn style='margin-left: 0.5em;' variant="tonal"
                                            @click="setDupPayLeastValidation()">
                                            즉시적용
                                            <VIcon end icon="tabler-direction-sign" />
                                        </VBtn>
                                    </div>
                                ...
                                <VCol md="8">
                                    <div class="batch-container">
                                        <VTextField v-model="pay_module.pay_dupe_limit" label="중복결제 허용회수" type="number"
                                            suffix="회 허용" />
                                        <VBtn style='margin-left: 0.5em;' variant="tonal"
                                            @click="setDupPayCountValidation()">
                                            즉시적용
                                            <VIcon end icon="tabler-direction-sign" />
                                        </VBtn>
                                    </div>
                        ...
                        <VCol :md=6>
                            <VRow no-gutters style="align-items: center;">
                                ...
                                <VCol md="8">
                                    <div class="batch-container">
                                        <VTextField prepend-inner-icon="tabler-currency-won"
                                            v-model="pay_module.pay_day_limit" type="number" suffix="만원" />
                        ...
                        <VCol :md=6>
                            <VRow no-gutters style="align-items: center;">
                                ...
                                <VCol md="8">
                                    <div class="batch-container">
                                        <VTextField prepend-inner-icon="tabler-currency-won"
                                            v-model="pay_module.pay_year_limit" type="number" suffix="만원" />
