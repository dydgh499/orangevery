...
Route::middleware('log.route')->group(function() {
    ...
    Route::middleware('auth:sanctum')->group(function() {
        Route::get('pay-modules', [BfController::class, 'transactionIndex']);
        Route::get('transactions', [BfController::class, 'realtimeHistoryIndex']);
        Route::get('realtime-histories', [BfController::class, 'payModules']);
