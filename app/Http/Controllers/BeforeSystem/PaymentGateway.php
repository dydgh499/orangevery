...
class PaymentGateway
{
    ...
    public function __construct()
    {
        $this->pg_companies = [
            ...
            ["id" => 18, "pg_name" => '애드원', "rep_name" => '김춘걸', "company_name" => '주식회사 에드원', "business_num" => '114-81-90678', "phone_num" => '554-4002', "addr" => '서울시 영등포구 당산로 41길 11, E동 1109호 (당산동 4가, 당산 SK V1센터)'],
            ...
            ["id" => 20, "pg_name" => '윈글로벌페이', "rep_name" => '우강섭', "company_name" => '(주)윈글로벌페이', "business_num" => '648-86-00577', "phone_num" => '1877-7590', "addr" => '[12918] 경기도 하남시 조정대로 45, 미사센텀비즈 F348호'],
            ...
            ["id" => 24, "pg_name" => '워너페이먼츠', "rep_name" => '황창우', "company_name" => '(주)워너페이먼츠', "business_num" => '864-88-01755', "phone_num" => '031-898-1775', "addr" => '경기 수원시 영통구 대학로 28, 3층'],
            ["id" => 25, "pg_name" => '버디페이', "rep_name" => '권성호', "company_name" => '(주)버디페이', "business_num" => '686-81-02591', "phone_num" => '031-898-1775', "addr" => '서울특별시 금천구 가산디지털2로 144, 1217~1220호'],
