...
class PaymentGateway
{
    ...
    public function __construct()
    {
        $this->pg_companies = [
            ...
            ["id" => 21, "pg_name" => '브라이트픽스(구)', "rep_name" => '박용은', "company_name" => '(주)브라이트픽스', "business_num" => '235-88-01772', "phone_num" => '02-6336-0999', "addr" => '주소 서울특별시 금천구 가산디지털2로 166, 216~217호(가산동, 에이스K1타워)'],
        ];
        $this->paywell = [];
        $this->payvery = [];
