...
class CreateMerchandisesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('merchandises', function (Blueprint $table) {
            ...
            //
            $table->float('hold_fee', 8, 5)->default(0)->comment('보유금액 수수료');
            $table->float('trx_fee', 8, 5)->default(0)->comment('거래 수수료');
            //
            ...
            $table->string('pv_options', 1000)->default('[]')->comment('가맹점 옵션');
